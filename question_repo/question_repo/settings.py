...
SECRET_KEY = '$2v!a#njp)u5q--zn*iak!xur0uxhyx1h-w$q3udpldhxi2h04'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://192.168.0.188:6379',
        "OPTIONS": {
...
# MEDIA_URL + CKEDITOR_UPLOAD_PATH(MEDIA_ROOT/CKEDITOR_UPLOAD_PATH)

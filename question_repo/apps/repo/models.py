...
class Questions(models.Model):
    ...
    # 富文本编辑器
    content = RichTextUploadingField("题目详情", null=True, config_name="default")
    # 富文本编辑器
    answer = RichTextUploadingField("题目答案", null=True, blank=True, config_name="awesome_ckeditor")
...
class AnswersCollection(models.Model):
    """收藏问题"""
    answer = models.ForeignKey(Answers, verbose_name="答案", related_name='answers_collection_set')
    ...
    def __str__(self):
        ...
        return f"{self.user}:{ret}:{self.answer.answer}"
